...
namespace SteamKit.Client.Model
{
    ...
    /// <summary>
    /// 隐私状态
    /// <see cref="CPrivacySettings.privacy_state"/>
    /// </summary>
    public enum EPrivacySettingsState
    {
        Private = 1,
        FriendsOnly = 2,
        Public = 3
    ...
    /// <summary>
    /// CMsgClientUserNotifications.Notification.user_notification_type
    /// <see cref="CMsgClientUserNotifications.Notification.user_notification_type"/>
    /// </summary>
    public enum EUserNotificationType
    {
        ...
        Items = 5,
        Invites = 6,
        Unknown7 = 7, // Unknown type of notification, never seen in the wild
        Gifts = 8,
        Chat = 9,
