namespace SteamKit.Client.Model.Proto
{
    ...
    public partial class ProtoBufHeader : ProtoBuf.IExtensible
    {
        ...
        [ProtoBuf.ProtoMember(10, DataFormat = ProtoBuf.DataFormat.FixedSize)]
        ...
        [ProtoBuf.ProtoMember(11, DataFormat = ProtoBuf.DataFormat.FixedSize)]
        [System.ComponentModel.DefaultValue(typeof(ulong), "18446744073709551615")]
        ...
        public int eresult
        {
            get => __pbn__eresult ?? (int)EResult.OK;
        ...
        public List<uint> forward_to_sysid { get; } = new List<uint>();
        ...
        public GCRoutingProtoBufHeader routing_gc { get; set; }

        [ProtoBuf.ProtoMember(15)]
        public uint ip
        {
            get => __pbn__ip_addr.Is(15) ? __pbn__ip_addr.UInt32 : default;
            set => __pbn__ip_addr = new ProtoBuf.DiscriminatedUnion32Object(15, value);
        }
        public bool ShouldSerializeip() => __pbn__ip_addr.Is(15);
        public void Resetip() => ProtoBuf.DiscriminatedUnion32Object.Reset(ref __pbn__ip_addr, 15);

        private ProtoBuf.DiscriminatedUnion32Object __pbn__ip_addr;

        [ProtoBuf.ProtoMember(29)]
        public byte[] ip_v6
        {
            get => __pbn__ip_addr.Is(29) ? (byte[])__pbn__ip_addr.Object : default;
            set => __pbn__ip_addr = new ProtoBuf.DiscriminatedUnion32Object(29, value);
        }
        public bool ShouldSerializeip_v6() => __pbn__ip_addr.Is(29);
        public void Resetip_v6() => ProtoBuf.DiscriminatedUnion32Object.Reset(ref __pbn__ip_addr, 29);

    }

    [ProtoBuf.ProtoContract()]
    public partial class GCRoutingProtoBufHeader : ProtoBuf.IExtensible
    {
        private ProtoBuf.IExtension __pbn__extensionData;
        ProtoBuf.IExtension ProtoBuf.IExtensible.GetExtensionObject(bool createIfMissing)
            => ProtoBuf.Extensible.GetExtensionObject(ref __pbn__extensionData, createIfMissing);
    ...
    public partial class GCProtoBufHeader : global::ProtoBuf.IExtensible
    {
